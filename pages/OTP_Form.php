...
if (!isset($_SESSION["Firstname"]) || !isset($_SESSION["Lastname"]) || !isset($_SESSION["otp"])) {
  ...
  <section class="auth-container">
    <div class="auth-box">
      <h1><i class="fa-solid fa-key"></i> Enter OTP
        <p style="margin-top: 10px;">Please check your email: <?php echo $_SESSION["Email"] ?></p>
        ...
        <form method="POST" action="OTP_Verify.php">
          <div class="form-group">
            <label>OTP</label>
            <input type="text" id="otpField" name="OTP_Field" placeholder="Enter OTP" required>
          </div>

          <button type="submit" class="submit-btn" name="OTP_Btn">Submit</button>
        </form>
    </div>
  </section>
